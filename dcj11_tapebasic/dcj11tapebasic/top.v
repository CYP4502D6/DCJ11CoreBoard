...
module top #(
    ...
    parameter integer SRAM_READ_WAIT_CYCLES = 0,
    ...
    wire [15:0] front_dal_out;
    wire        front_dal_oe;
    wire        front_cont_n;
    wire        front_sram_owns;
    wire [20:0] front_sram_addr;
    wire        front_sram_ce1_n;
    wire        front_sram_oe_n;
    wire        front_sram_we_lo_n;
    wire        front_sram_we_hi_n;
    ...
    wire [21:0] dcj_addr_now = {dcj_dal_hi, dcj_dal};
    ...
    assign dcj_dal    = front_dal_oe ? front_dal_out :
                        core_dal_oe ? core_dal_out :
                        16'hzzzz;
    assign dcj_init_n = (FPGA_DRIVE_INIT && init_drive_low) ? 1'b0 : 1'bz;

    assign dcj_cont_n  = core_cont_n | front_cont_n;
    ...
    assign sram_addr    = front_sram_owns ? front_sram_addr : core_sram_addr;
    assign sram_ce1_n   = front_sram_owns ? front_sram_ce1_n : core_sram_ce1_n;
    assign sram_oe_n    = front_sram_owns ? front_sram_oe_n : core_sram_oe_n;
    assign sram_we_lo_n = front_sram_owns ? front_sram_we_lo_n : core_sram_we_lo_n;
    assign sram_we_hi_n = front_sram_owns ? front_sram_we_hi_n : core_sram_we_hi_n;
    ...
    dcj11_bus_frontend #(
        ...
        .dal_out(front_dal_out),
        .dal_oe(front_dal_oe),
        .cont_n(front_cont_n),
        .sram_owns(front_sram_owns),
        .sram_addr(front_sram_addr),
        .sram_ce1_n(front_sram_ce1_n),
        .sram_oe_n(front_sram_oe_n),
        .sram_we_lo_n(front_sram_we_lo_n),
        .sram_we_hi_n(front_sram_we_hi_n)
    );
    ...
    dcj11tapebasic_core #(
        ...
        .SRAM_READ_HOLD_CYCLES(SRAM_READ_HOLD_CYCLES),
        .ENABLE_CORE_MEM_READS(1'b0),
        ...
        .sram_ce1_n(core_sram_ce1_n),
        .sram_oe_n(core_sram_oe_n),
        .sram_we_lo_n(core_sram_we_lo_n),
        .sram_we_hi_n(core_sram_we_hi_n),
        .uart_rx(uart_rx),
        .uart_tx(uart_tx),
        .sd_miso(sd_spi_miso),
        .sd_sck(sd_spi_sck),
    ...
    wire unused_clk_param = |CLK_HZ[31:0];
